        ...
        <header className={styles.header}>
            <div className={`${styles.logo} ${styles.item}`}>
                <Link to='/' className={styles.logoLink}>
                    <svg className={styles.iconSvg} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
            ...
            <div className={`${styles.account} ${styles.item}`}>
                {user ?
                    <>
                        <div className={`${styles.dropdown}`}>
                            ...
                            <div className={styles.dropdownContent}>
                                ...
                                <button className={styles.dropdownButton} onClick={() => nav('/settings')}>Settings⚙︎ </button>
                    ...
                    :
                    <>
                        <button className={buttonStyles.button} onClick={() => nav('/login')} >LogIn</button>
                        <button className={buttonStyles.button} onClick={() => nav('/signup')} >Signup</button>
                    </>
                }
